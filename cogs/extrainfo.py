...
class ExtraInfo(commands.Cog, description="Another infomation cog cuz I felt uncomfortable"):
    ...
    @commands.guild_only()
    @commands.command(aliases=["guildchart"], help="Generates a pie chart, representing the last 1000 messages from every allowed channel in the server. (Credits to aikaterna)")
