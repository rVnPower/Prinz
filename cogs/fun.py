...
from utils.requests import async_post_json
#####################################################
...
class Fun(commands.Cog, description="idk", name="Fun"):
	...
	async def dog(self, ctx):
		...
		result = async_post_json(f'https://dog.ceo/api/breeds/image/random')
	...
	async def duck(self, ctx):
		...
		result = async_post_json(f'https://random-d.uk/api/random?format=json')
	...
	async def tellmeajoke(self, ctx):
		...
		result = await async_post_json(f'https://yourmommmaosamaobama.hisroyal123.repl.co/?message=tell%me%a%joke')
	...
	async def meme(self, ctx: commands.Context):
		...
		data = await async_post_json("https://meme-api.herokuapp.com/gimme")
	...
	async def quote(self, ctx):
		results = await async_post_json('https://type.fit/api/quotes')
	...
	async def advice(self, ctx):
		result = await async_post_json('https://api.adviceslip.com/advice')
	...
	async def randomname(self, ctx):
		result = await async_post_json('https://nekos.life/api/v2/name')
