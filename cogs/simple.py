...
class Simple(commands.Cog):
    ...
    @cog_ext.cog_slash(name="help", description="If you need help.", guild_ids=guild_ids)
    ...
    @cog_ext.cog_slash(name="hi", description="She will greet you!", guild_ids=guild_ids)
    async def _hi(self, ctx: SlashContext):
        # Say hi!
        await ctx.send(f'Hi! {ctx.author.mention}')

    @cog_ext.cog_slash(name="ping", description="Checks bot latency.", guild_ids=guild_ids)
    ...
    @cog_ext.cog_slash(name="admin", description="Display informations about bot owner.", guild_ids=guild_ids)
